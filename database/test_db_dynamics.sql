...
-- Add "is owned by college store" to the textbooks section
-- Tickbox late stuff
...
-- CREATE PROCEDURE GetLateTextbookRentals()
-- BEGIN
--     SELECT student_id, student_name, student_surname, book_name, rental_date, due_date
--     FROM Students
--     INNER JOIN TextbookRentals ON Students.student_id = TextbookRentals.student_id
